...
<!-- Mirrored from wpkixx.com/html/pitnik/fav-events.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Mar 2022 16:36:35 GMT -->
<head>
									...
									<div class="row">
										<div class="col-lg-2">
											<div class="profile-author">
												...
												<div class="author-content">
													<a class="h4 author-name" href="#">Ocean Motel</a>
										...
										<div class="col-lg-10">
											<ul class="profile-menu">
												<li>
													<a class="" href="fav-page.html">Page Feed</a>
												</li>
												<li>
													<a class="" href="fav-favers.html">Followers</a>
												</li>
												<li>
													<a class="active" href="fav-events.html">Events</a>
												</li>
												<li>
													<a class="" href="fav-event-invitations.html">Invitations</a>
												</li>
												<li>
													<a class="" href="event-calendar.html">Calender</a>
												</li>
												<li>
													<a href="fav-page-create.html" title="Create New Page"><i class="fa fa-plus-circle"></i></a>
												</li>
											</ul>
								...
								<aside class="sidebar static left">
									...
									<div class="widget stick-widget">
										...
										<ul class="fav-community">
											...
											<li><i class="fa fa-map-marker"></i><a href="http://wpkixx.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="0f406c6a6e615062607b6a634f76607a7d626e6663216c6062">[email&#160;protected]</a></li>
										</ul>
									</div><!-- Page Community-->
										...
										<div class="row">
											<div class="col-lg-12">
													...
													<div class="row merged20">
														...
														<div class="col-lg-6 col-md-6 col-sm-5">
															<div class="event-title">
																...
																<h4><a href="#" title="">Ocean Motel good night event in columbia for the youngests only.</a></h4>
												...
												<div class="event-box">
													<div class="row merged20">
														<div class="col-lg-4 col-md-4 col-sm-5">
															<figure class="event-thumb"><img src="images/resources/event5.jpg" alt=""></figure>
														</div>
														<div class="col-lg-6 col-md-6 col-sm-5">
															<div class="event-title">
																<span><i class="fa fa-clock-o"></i> 02:30PM to 04:30PM</span>
																<h4><a href="#" title="">International Conference in Frankfurt</a></h4>
																<ul class="sociaz-media">
																	<li><a title="" href="#" class="facebook"><i class="fa fa-facebook"></i></a></li>
																	<li><a title="" href="#" class="twitter"><i class="fa fa-twitter"></i></a></li>
																	<li><a title="" href="#" class="instagram"><i class="fa fa-instagram"></i></a></li>
												...
												<div class="event-box">
													<div class="row merged20">
														<div class="col-lg-4 col-md-4 col-sm-5">
															<figure class="event-thumb"><img src="images/resources/event3.jpg" alt=""></figure>
														</div>
														<div class="col-lg-6 col-md-6 col-sm-5">
															<div class="event-title">
																<span><i class="fa fa-clock-o"></i> 11:00AM to 02:30PM</span>
																<h4><a href="#" title="">What is R3 Move Business Conference?</a></h4>
																<ul class="sociaz-media">
																	<li><a title="" href="#" class="facebook"><i class="fa fa-facebook"></i></a></li>
																	<li><a title="" href="#" class="twitter"><i class="fa fa-twitter"></i></a></li>
																	<li><a title="" href="#" class="instagram"><i class="fa fa-instagram"></i></a></li>
												...
												<div class="event-box">
													<div class="row merged20">
														<div class="col-lg-4 col-md-4 col-sm-5">
															<figure class="event-thumb"><img src="images/resources/event1.jpg" alt=""></figure>
														</div>
														<div class="col-lg-6 col-md-6 col-sm-5">
															<div class="event-title">
																<span><i class="fa fa-clock-o"></i> 11:20AM to 01:30PM</span>
																<h4><a href="#" title="">2016 The 3rd International Conference on Advances in Business.</a></h4>
																<ul class="sociaz-media">
																	<li><a title="" href="#" class="facebook"><i class="fa fa-facebook"></i></a></li>
																	<li><a title="" href="#" class="twitter"><i class="fa fa-twitter"></i></a></li>
																	<li><a title="" href="#" class="instagram"><i class="fa fa-instagram"></i></a></li>
												...
												<div class="event-box">
													<div class="row merged20">
														<div class="col-lg-4 col-md-4 col-sm-5">
															<figure class="event-thumb"><img src="images/resources/event2.jpg" alt=""></figure>
														</div>
														<div class="col-lg-6 col-md-6 col-sm-5">
															<div class="event-title">
																<span><i class="fa fa-clock-o"></i> 10:00AM to 12:00AM</span>
																<h4><a href="#" title="">Bring More Customer Traffic to Your Store or Website</a></h4>
																<ul class="sociaz-media">
																	<li><a title="" href="#" class="facebook"><i class="fa fa-facebook"></i></a></li>
																	<li><a title="" href="#" class="twitter"><i class="fa fa-twitter"></i></a></li>
																	<li><a title="" href="#" class="instagram"><i class="fa fa-instagram"></i></a></li>
...
<!-- Mirrored from wpkixx.com/html/pitnik/fav-events.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Mar 2022 16:36:49 GMT -->
</html>