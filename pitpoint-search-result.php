...
<!-- Mirrored from wpkixx.com/html/pitnik/pitpoint-search-result.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Mar 2022 16:34:05 GMT -->
<head>
						...
						<div class="row merged20" id="page-contents">
							<div class="col-lg-12">
								<div class="search-meta">
									<span>Your search result for " <i>Sophia Jane</i> " 12</span>
								</div>
							</div>
							<div class="col-lg-3">
										...
										<form class="c-form search" method="post">
											<div>
												...
												<div class="form-radio">
												  <div class="radio">
													<label>
													  <input type="radio" checked="checked" name="radio"><i class="check-box"></i>Best Match
													</label>
												  </div>
												  <div class="radio">
													<label>
													  <input type="radio" name="radio"><i class="check-box"></i>Top Views
													</label>
												  </div>
													<div class="radio">
													<label>
													  <input type="radio" name="radio"><i class="check-box"></i>Less views
													</label>
												  </div>
												</div>
											</div>
							...
							<div class="col-lg-7">
								...
								<div class="central-meta item">
									...
									<ul class="related-searches">
										<li><a title="" href="#">Sophia jane jr.</a></li>
										<li><a title="" href="#">Sophia Pool</a></li>
										<li><a title="" href="#">Sofia fdny </a></li>
										<li><a title="" href="#">Sophia chevrolet cadillac </a></li>
										<li><a title="" href="#">Sophia sophia </a></li>
									</ul>
