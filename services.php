...
<head>
	...
	<title>uNepal Social Network</title>
			...
			<div class="top-area">
				...
				<div class="top-search">
					<form method="post" class="">
						<input type="text" placeholder="Search People, Pages, #tags etc">
				...
				<ul class="setting-area">
					...
					<li>
						<a href="#" title="Messages" data-ripple=""><img src="images/svg/chat.svg" alt=""><em class="bg-blue">9</em></a>
						<div class="dropdowns">
					...
					<li><a href="#" title="Languages" data-ripple=""><img src="images/svg/globe.svg" alt=""><em class="dark">ACT</em></a>
						<div class="dropdowns languages">

							<ul class="drops-menu">
								<li> <a href="#"> ACT </a> </li>
								<li class="active"> <a href="#"> NSw </a> </li>
								<li> <a href="#"> VIC </a> </li>
							</ul>
								...
								<div class="col-lg-3 d-none d-lg-block">
									<aside class="sidebar static left ">
										<div class="widget">
											...
											<div class="your-page">
												<figure>
													<a href="#" title=""><img src="images/resources/friend-avatar8.jpg" alt=""></a>
													<span>@Monica12</span>
												</figure>
												<div class="page-meta">
												...
												<div class="page-likes">
													<ul class="nav nav-tabs likes-btn">
														<li class="nav-item"><a class="active" href="#folower" data-toggle="tab" data-ripple="">Followers</a></li>
														<li class="nav-item"><a class="" href="#folwing" data-toggle="tab" data-ripple="">Following</a></li>
													</ul>
													<!-- Tab panes -->
													<div class="tab-content">
														<div class="tab-pane active fade show " id="folower">
															<span><i class="ti-heart"></i>120K</span>
															<a href="#" title="weekly-likes">22 new Folowers this
																week</a>
														...
														<div class="tab-pane fade" id="folwing">
															<span><i class="fa fa-eye"></i>440k</span>
										...
										<div class="widget">
											...
											<ul class="widget-video">
												<li>
													<a href="https://www.youtube.com/watch?v=UXnxgRyGzJQ" title="" data-strip-group="mygroup" class="strip" data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img src="images/resources/last-vid1.jpg" alt="">
														<i>
												...
												<li>
													<a href="https://www.youtube.com/watch?v=PDluztBSaBc" title="" data-strip-group="mygroup" class="strip" data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img src="images/resources/last-vid2.jpg" alt="">
												...
												<div class="status-story">
													...
													<div class="row">
														...
														<div class="col-lg-8">
															...
															<div id="slideshow">
																<img class="slide" src="../../../placehold.it/856x380/FF6347/FFFFFF%26text%3d1" alt="11" />
																<img class="slide" src="../../../placehold.it/856x380/6FC6F7/FFFFFF%26text%3d2" alt="2" />
																<img class="slide" src="../../../placehold.it/856x380/f3e686/FFFFFF%26text%3d3" alt="3" />
																<img class="slide" src="../../../placehold.it/856x380/71eea3/FFFFFF%26text%3d4" alt="4" />
															</div>
														</div>
													</div>
												</div>
											...
											<div class="user-post">
												<div class="friend-info">
													...
													<div class="friend-name">
														...
														<ins><a href="time-line" title="">Monica Joshi</a> Post
															Album</ins>
													...
													<div class="coment-area" style="display: block;">
														<ul class="we-comet">
															...
															<li>
																...
																<div class="we-comment">
																	<h5><a href="time-line" title="">Sophia</a>
																	</h5>
																	<p>we are working for the dance and sing songs. this
											...
											<div class="user-post">
												<div class="friend-info">
													...
													<div class="friend-name">
														...
														<ins><a href="time-line" title="">Mathilda
																Brinker</a></ins>
											...
											<div class="user-post">
												<div class="friend-info">
													...
													<div class="friend-name">
														...
														<ins><a href="time-line" title="">Sophia</a> shared
															location</ins>
														<span><i class="fa fa-globe"></i> published: january,5 2010
															19:PM</span>
													</div>
								...
								<div class="col-lg-3">
									<aside class="sidebar static right">
										...
										<div class="widget">
											...
											<ul class="nav nav-tabs trend">
												<li class="nav-item"><a class="active" href="#trend" data-toggle="tab">Trending</a></li>
												<li class="nav-item"><a class="" href="#hot" data-toggle="tab">Hot</a>
												</li>
											</ul>
											<!-- Tab panes -->
											<div class="tab-content">
												<div class="tab-pane active fade show " id="trend">
													<ul class="recent-links">
														<li>
															<figure><img alt="" src="images/resources/recentlink-1.jpg">
															</figure>
												...
												<div class="tab-pane fade" id="hot">
													<ul class="more-songs">
														<li>
															<figure><img alt="" src="images/resources/song-chanl1.jpg">
															</figure>
															<div class="song-title">
																<h6><a title="" href="#">6 Kiss (Feat. JuiceWrld &amp;
																		YNW Melly)</a></h6>
																<a title="" href="#">by Yung Bans</a>
															</div>
														</li>
														<li>
															<figure><img alt="" src="images/resources/song-chanl2.jpg">
															</figure>
															<div class="song-title">
																<h6><a title="" href="#">A love letter to you for</a>
																</h6>
																<a title="" href="#">by Trippie Redd</a>
															</div>
														</li>
														<li>
															<figure><img alt="" src="images/resources/song-chanl3.jpg">
															</figure>
															<div class="song-title">
																<h6><a title="" href="#">Strings feat. Gunna
																		Official</a></h6>
																<a title="" href="#">by iann dior</a>
															</div>
														</li>
														<li>
															<figure><img alt="" src="images/resources/song-chanl4.jpg">
															</figure>
															<div class="song-title">
																<h6><a title="" href="#">Partna in Crime</a></h6>
																<a title="" href="#">by Lil Tecca</a>
															</div>
														</li>
														<li>
															<figure><img alt="" src="images/resources/song-chanl5.jpg">
															</figure>
															<div class="song-title">
																<h6><a title="" href="#">Majin Mafia official song</a>
																</h6>
										...
										<div class="widget">
											<h4 class="widget-title">Upcoming Events <a title="" href="#" class="see-all">See All</a></h4>
										...
										<div class="widget">
											<div class="banner high-opacity purple">
												<div class="bg-image" style="background-image: url(images/resources/baner-widgetbg2.jpg)">
												</div>
												<div class="post-job">
													<img src="images/job-icon.png" alt="">
													<span>Post a new job</span>
													<p>Create a new job post for hire a new talented from the uNepal</p>
										...
										<div class="widget">
											<div class="post-creat">
												...
												<div class="create-meta">
													...
													<p>
														The Best Post on uNepal for you, Pulled from the most active
														communities on uNepal. Check here to see the most shared,
										...
										<div class="widget uNepal-links stick-widget">
											<ul>
												<li><a href="#" title="">about</a></li>
												<li><a href="#" title="">career</a></li>
												<li><a href="#" title="">advertise</a></li>
												<li><a href="#" title="">uNepal Apps</a></li>
												<li><a href="#" title="">uNepal Blog</a></li>
												<li><a href="#" title="">Help</a></li>
												<li><a href="#" title="">uNepal Gifts</a></li>
												<li><a href="#" title="">contetn policy</a></li>
												<li><a href="#" title="">User Policy</a></li>
											</ul>
											<p>© uNepal 2020. All Rights Reserved.</p>
										</div><!-- little links -->
									</aside>
								</div><!-- sidebar -->
							</div>
