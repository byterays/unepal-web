...
<!-- Mirrored from wpkixx.com/html/pitnik/soundnik.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Mar 2022 16:30:32 GMT -->
<head>
	...
	<section>
		<div class="gap2 gray-bg">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<div class="soundnik-featured">
							<figure><img src="images/resources/soundnik.jpg" alt=""></figure>
							<figure><img src="images/resources/soundnik2.jpg" alt=""></figure>
							<figure><img src="images/resources/soundnik3.jpg" alt=""></figure>
						</div>
						<div class="soundnik-meta">
							<h1>Connect on Soundnik</h1>
							<p>Discover, stream and share an ever-expanding mix of music from emerging and great artists from around the world.</p>
							<a href="#" title="" class="main-btn">Sign Up for Free</a>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="col-lg-12">
						<div class="row merged20" id="page-contents">
							<div class="col-lg-9">
										...
										<div class="row">
											<div class="col-lg-4">
												<div class="align-left">
													<h5><i class="fa fa-free-code-camp"></i> Newest Trending</h5>
												</div>
											</div>
											<div class="col-lg-8">
												<div class="row merged20">
													<div class="col-lg-7 col-md-7 col-sm-7">
														<form method="post">
															<input type="text" placeholder="Search Music,artist, band, tracks..">
								...
								<div class="todays mate-black medium-opacity">
									<div class="bg-image" style="background-image: url(images/resources/soundnik.jpg)"></div>
									<h4 class="sound-title">Today's Most trending for free in the Soundnik community</h4>
									<div class="sound-post-box">
										<div class="sound-user">
											<figure><img src="images/resources/sound-user1.jpg" alt=""></figure>
											<div class="sound-usr-nm">
												<h6>Sings Street</h6>
												<span><i class="fa fa-map-marker"></i> Canada</span>
											</div>
										</div>
										<h4 class=""><a href="#" title="">Check Dis (feat. NLE Choppa) [Remix]..</a></h4>
										<span><i class="fa fa-cloud-upload"></i> 22 jan, 2020</span>
										<div class="sound-track-area">
											<div class="music-track">
											  <div class="playerOuter" data-ap data-ap-file="https://ia800508.us.archive.org/15/items/LoveThemeFromTheGodfather/02LoveThemeFromTheGodfather.mp3" data-ap-width="900" data-ap-amplify="1" data-ap-scaleFactor="40"></div>
											</div>
											<ul class="pit-opt">
												<li>
										...
										<div class="sound-right">
											<span class="play-list" title="Play List" data-toggle="tooltip" data-placement="top"><img src="images/play-list-icon.png" alt=""></span>
											<a href="#" title="" class="send-mesg">Send Message</a>
											<a href="#" title="" class="main-btn2">Add Friend</a>
										</div>
									</div>
								</div>
								<div class="row merged20">
										...
										<div class="central-meta audio-box">
											<div class="audio-post">
												<div class="audio-user">
													<figure><img src="images/resources/audio-user1.jpg" alt=""></figure>
													<div class="audio-user-name">
														<h6><a href="#" title="">Nati Natasha</a></h6>
														<span><i class="fa fa-cloud-upload"></i> March 22, 2020</span>
													</div>
												</div>
												<div class="more">
												...
												<div class="add-send">
													<a href="#" title="" class="send-mesg">Send Message</a>
													<ul>
														<li><a href="#" title="Add Friend"><i class="fa fa-user-plus"></i></a></li>
														<li><a href="#" title="Play List"><img src="images/play-list-icon.png" alt=""></a></li>
													</ul>
												</div>
											</div>
											
											<h4 class="audio-title"><a href="soundnik-detail.html" title="">Natti Natasha x Anitta  - Te lo Dije</a></h4>
											<figure class="audio-wave"><img src="images/audio-wave.png" alt=""></figure>
										</div>
									</div>
									<div class="col-lg-6 col-md-6">
										<div class="central-meta audio-box">
											<div class="audio-post">
												<div class="audio-user">
													<figure><img src="images/resources/audio-user2.jpg" alt=""></figure>
													<div class="audio-user-name">
														<h6><a href="#" title="">Keily Queen</a></h6>
														<span><i class="fa fa-cloud-upload"></i> April 2, 2020</span>
													</div>
												</div>
												<div class="more">
													<div class="more-post-optns"><i class="ti-more-alt"></i>
											...
											<h4 class="audio-title"><a href="soundnik-detail.html" title="">Bandit ft. NBA Youngboy</a></h4>
											<figure class="audio-wave"><img src="images/audio-wave.png" alt=""></figure>
										</div>
									</div>
									<div class="col-lg-6 col-md-6">
										<div class="central-meta audio-box">
											<div class="audio-post">
												<div class="audio-user">
													<figure><img src="images/resources/audio-user3.jpg" alt=""></figure>
													<div class="audio-user-name">
														<h6><a href="#" title="">Lady Baga</a></h6>
														<span><i class="fa fa-cloud-upload"></i> May 20, 2020</span>
													</div>
												</div>
												<div class="more">
													<div class="more-post-optns"><i class="ti-more-alt"></i>
											...
											<h4 class="audio-title"><a href="soundnik-detail.html" title="">Aleisha Maureen</a></h4>
											<figure class="audio-wave"><img src="images/audio-wave.png" alt=""></figure>
										</div>
									</div>
									<div class="col-lg-6 col-md-6">
										<div class="central-meta audio-box">
											<div class="audio-post">
												<div class="audio-user">
													<figure><img src="images/resources/audio-user4.jpg" alt=""></figure>
													<div class="audio-user-name">
														<h6><a href="#" title="">Shakra sing</a></h6>
														<span><i class="fa fa-cloud-upload"></i> Jan 12, 2020</span>
													</div>
												</div>
												<div class="more">
													<div class="more-post-optns"><i class="ti-more-alt"></i>
											...
											<h4 class="audio-title"><a href="soundnik-detail.html" title="">A moment to late official</a></h4>
											<figure class="audio-wave"><img src="images/audio-wave.png" alt=""></figure>
										</div>
									</div>
									<div class="col-lg-6 col-md-6">
										<div class="central-meta audio-box">
											<div class="audio-post">
												<div class="audio-user">
													<figure><img src="images/resources/audio-user5.jpg" alt=""></figure>
													<div class="audio-user-name">
														<h6><a href="#" title="">Amy watson</a></h6>
														<span><i class="fa fa-cloud-upload"></i> Feb 25, 2020</span>
													</div>
												</div>
												<div class="more">
													<div class="more-post-optns"><i class="ti-more-alt"></i>
											...
											<h4 class="audio-title"><a href="soundnik-detail.html" title="">Every Body in the night</a></h4>
											<figure class="audio-wave"><img src="images/audio-wave.png" alt=""></figure>
										</div>
									</div>
									<div class="col-lg-6 col-md-6">
										<div class="central-meta audio-box">
											<div class="audio-post">
												<div class="audio-user">
													<figure><img src="images/resources/audio-user6.jpg" alt=""></figure>
													<div class="audio-user-name">
														<h6><a href="#" title="">Sandy</a></h6>
														<span><i class="fa fa-cloud-upload"></i> March 22, 2020</span>
													</div>
												</div>
												<div class="more">
											...
											<h4 class="audio-title"><a href="soundnik-detail.html" title="">Pal Jalebi Remix song</a></h4>
											<figure class="audio-wave"><img src="images/audio-wave.png" alt=""></figure>
										</div>
									</div>
									<div class="lodmore">
										<span>Viewing 1-6 of 2044 posts</span>
								...
								<aside class="sidebar static right">
									...
									<div class="widget">
										...
										<div class="pit-tags">
											<a href="#" title="">Pop</a>
											<a href="#" title="">Rock</a>
											<a href="#" title="">Rap song</a>
											<a href="#" title="">Classic</a>
											<a href="#" title="">HipHop</a>
											<a href="#" title="">Love</a>
											<a href="#" title="">Mashup</a>
										</div>
									</div><!-- tags -->
								</aside>
							</div><!-- sidebar -->
...
<!-- Mirrored from wpkixx.com/html/pitnik/soundnik.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Mar 2022 16:30:44 GMT -->
</html>	