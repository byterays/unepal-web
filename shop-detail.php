...
<!-- Mirrored from wpkixx.com/html/pitnik/shop-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Mar 2022 16:40:03 GMT -->
<head>
									...
									<div class="central-meta">
										<div class="prod-avatar">
											<ul class="slider-for-gold">
												 <li><img src="images/resources/product1.jpg" alt=""></li>
												 <li><img src="images/resources/product2.jpg" alt=""></li>
												 <li><img src="images/resources/product3.jpg" alt=""></li>
												 <li><img src="images/resources/product4.jpg" alt=""></li>
											</ul>
								...
								<div class="col-lg-6">
    								<div class="central-meta">
										<div class="full-postmeta">
											...
											<h4>Moon Blue DVD <span>Big Bang</span> Movie</h4>
											<p>
											...
											<div class="post-as">
												<div class="prod categories">
													<span class="cat-heading">Categories:
														<a title="" href="#">Movie Ticket</a>
														<a title="" href="#">Web Themes</a>
													</span>
												</div>
												<div class="prod tags">
													<span class="cat-heading">Tags:
														<a title="" href="#">Movies</a>
														<a title="" href="#">Digital Product</a>
														<a title="" href="#">Hosting</a>
													</span>
												</div>
											</div>
											<div class="extras">
												<a href="https://www.youtube.com/watch?v=XNeFJzO8v9c" title="" data-strip-group="mygroup" class="strip play-btn"><i class="fa fa-play-circle"></i> play video</a>
												<a title="" data-group="set2" class="html5lightbox btn2" href="#">
												</a>
											</div>
										</div>
									</div>
										...
										<div class="tab-section ruby">
											...
											<div class="tab-content">
											  <div class="tab-pane active fade show " id="desc" >
												<div class="more-pix">
													<span class="user-post"><i class="fa fa-user"></i> By Mark Sullivan  - (Author),</span>
													<h2 class="main-title">Blue Moon Hollywood Full Movie DVD</h2>
													<div class="row">
														<div class="col-lg-12">
															<p class="prod-info">
											  ...
											  <div class="tab-pane fade" id="additional" >
												<div class="aditional-inf">
													<h2 class="main-title">Moon Bouldering<span> Bag Jet</span> Black</h2>
											  ...
											  <div class="tab-pane fade" id="review">
													<div class="woocommerce-Reviews">
																...
																<li>
																	<div class="comment_container">
																		...
																		<div class="comment-text">
																			<span class="user-name">Johannes Kepler</span>
														...
														<div id="respond" class="comment-respond">
															<h3 class="reply-title">Add New Review:</h3>
															<form method="post">
...
<!-- Mirrored from wpkixx.com/html/pitnik/shop-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Mar 2022 16:40:11 GMT -->
</html>