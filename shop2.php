...
<!-- Mirrored from wpkixx.com/html/pitnik/shop2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Mar 2022 16:55:56 GMT -->
<head>
										...
										<form class="c-form search" method="post">
											<div>
												...
												<div class="form-radio">
												  <div class="radio">
													<label>
													  <input type="radio" checked="checked" name="radio"><i class="check-box"></i>All categories
													</label>
												  </div>
												  <div class="radio">
													<label>
													  <input type="radio" name="radio"><i class="check-box"></i>PSD Template
													</label>
												  </div>
													<div class="radio">
													<label>
													  <input type="radio" name="radio"><i class="check-box"></i>Html Template
													</label>
												  </div>
													<div class="radio">
													<label>
													  <input type="radio" name="radio"><i class="check-box"></i>Wordpress Theme
													</label>
												  </div>
												</div>
											</div>
								...
								<div class="central-meta">
									...
									<div class="row">
										<div class="col-lg-6 col-md-6">
											<div class="dig-pro">
												...
												<div class="digi-meta">
													...
													<p>Full E-Marketing for your digital product with cheap budget using social media </p>
													<div class="rate">
														<ol class="pit-rate">
															<li class="rated"><i class="fa fa-star"></i></li>
															<li class="rated"><i class="fa fa-star"></i></li>
										...
										<div class="col-lg-6 col-md-6">
											<div class="dig-pro">
												<figure>
													<img src="images/resources/dig-product3.jpg" alt="">
													<div class="user-avatr">
														<img alt="" src="images/resources/user13.jpg">
														<div>
															<span>Posted by</span>
															<ins>Andrew</ins>
														</div>
												...
												<div class="digi-meta">
													...
													<div class="rate">
														...
														<span class="qeemat"><del>70</del>$50</span>
													</div>
												</div>												
											</div>
										</div>
										...
										<div class="col-lg-6 col-md-6">
											<div class="dig-pro">
												<figure>
													<img src="images/resources/dig-product5.jpg" alt="">
													<div class="user-avatr">
														<img alt="" src="images/resources/user10.jpg">
														<div>
															<span>Posted by</span>
															<ins>Peterson</ins>
														</div>
