...
<!-- Mirrored from wpkixx.com/html/pitnik/pittube-channel.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Mar 2022 16:33:31 GMT -->
<head>
						...
						<div class="row merged20" id="page-contents">
							<div class="user-profile">
								<figure>
									...
									<img src="images/resources/profile-image2.jpg" alt="">
									...
									<div class="row">
										<div class="col-lg-2">
											<div class="profile-author">
												...
												<div class="author-content">
													<a class="h4 author-name" href="02-ProfilePage.html">Hobo Tv</a>
										...
										<div class="col-lg-10 col-md-9">
											<ul class="nav nav-tabs links-tab">
												 <li class="nav-item"><a class="active" href="#link1" data-toggle="tab">About</a></li>
												 <li class="nav-item"><a class="" href="#link2" data-toggle="tab">Videos</a></li>
												 <li class="nav-item"><a class="" href="#link3" data-toggle="tab">History</a></li>
												 <li class="nav-item"><a class="" href="#link4" data-toggle="tab">Followers <span>340</span></a></li>
												 <li class="nav-item"><a class="" href="#link5" data-toggle="tab">Follow <span>123</span></a></li>
												<li class="nav-item"><a class="" href="#link6" data-toggle="tab">Community</a></li>
											</ul>
										</div>
									</div>
								</div>	
							...
							<div class="col-lg-12">
								<div class="tab-content">
										...
										<div class="row merged20">
											<div class="col-lg-7">
												<div class="central-meta">
													...
													<iframe height="330" src="https://www.youtube.com/embed/X4YsJt4rIOI" allowfullscreen></iframe>
												</div>	
											</div>
											<div class="col-lg-5">
												<div class="central-meta">
													...
													<div class="about-chnl">
														...
														<span>Contribute us to promote our channel for better performance and you may hire us as freelance</span>
											...
											<div class="col-lg-12">
												<div class="central-meta">
													<span class="create-post">Contributors</span>
													<ul class="contributorz">
														<li>
															<img src="images/resources/ceo1.jpg" alt="">
															<span>Jhon Doe</span>
															<p>Ceo Abc.inc, Canada</p>
														</li>
														<li>
															<img src="images/resources/ceo2.jpg" alt="">
															<span>Barak Obama</span>
															<p>Ceo A to Z Cars, USA</p>
														</li>
														<li>
															<img src="images/resources/ceo3.jpg" alt="">
															<span>tayab ahmed</span>
															<p>Ceo Abc.inc, Turky</p>
														</li>
														<li>
															<img src="images/resources/ceo4.jpg" alt="">
															<span>Moosa ismial</span>
															<p>Ceo infotech ltd, Malaysia</p>
														</li>
														<li>
															<img src="images/resources/ceo5.jpg" alt="">
															<span>Mohammad bin saad</span>
															<p>HOD, Alfutim Group, Dubai</p>
														</li>
														<li>
															<img src="images/resources/ceo6.jpg" alt="">
															<span>Salhe Ibhrahim</span>
															<p>Ceo alwasita LLC, Saudia</p>
														</li>
														<li>
															<img src="images/resources/ceo7.jpg" alt="">
															<span>Xong hing</span>
															<p>Partner Xing xang Ltd, China</p>
														</li>
														<li>
															<img src="images/resources/ceo8.jpg" alt="">
															<span>Frank Bob</span>
									...
									<div class="tab-pane fade" id="link3" >
										<div class="central-meta">
											<div class="create-post">Your's Last Visited Videos</div>
											<div class="row merged20">
												<div class="col-lg-3 col-md-4 col-sm-6">
													<div class="tube-post">
														<figure>
									...
									<div class="tab-pane fade" id="link4">
										<div class="central-meta">
											<div class="create-post">Followers</div>
												<div class="row merged20">
									...
									<div class="tab-pane fade" id="link5">
										<div class="central-meta">
											<div class="create-post">Following</div>
											<div class="row merged20">
												<div class="col-lg-3 col-md-6 col-sm-6">
													<div class="friend-block">
														<div class="more-opotnz">
											...
											<div class="user-post">
												<div class="friend-info">
													...
													<div class="friend-name">
														...
														<ins><a title="" href="time-line.html">Jack Carter</a> Post</ins>
													...
													<div class="post-meta searched">
														<div class="linked-image align-right">
															<a title="" href="#"><img alt="" src="images/resources/search-2.jpg"></a>
														</div>
														<div class="detail">
														...
														<ul class="we-comet">
															<li>
																<div class="comet-avatar">
																	<img alt="" src="images/resources/comet-1.jpg">
																</div>
															...
															<li>
																<div class="comet-avatar">
																	<img alt="" src="images/resources/comet-2.jpg">
																</div>
																<div class="we-comment">
										...
										<div class="central-meta no-margin">
											<div class="user-post">
												<div class="friend-info">
													...
													<div class="post-meta searched">
														<div class="linked-image align-right">
															<a title="" href="#"><img alt="" src="images/resources/search-1.jpg"></a>
														</div>
														<div class="detail">
															<p>Lorem ipsum dolor sit amet, consectetur ipisicing elit, sed do eiusmod tempor incididunt ut labor... </p>
														</div>		
...
<!-- Mirrored from wpkixx.com/html/pitnik/pittube-channel.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Mar 2022 16:33:53 GMT -->
</html>	