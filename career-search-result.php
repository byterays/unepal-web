...
<!-- Mirrored from wpkixx.com/html/pitnik/career-search-result.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Mar 2022 16:34:09 GMT -->
<head>
	...
	<div class="fixed-sidebar left">
		<div class="menu-left">
			<ul class="left-menu">
				...
				<li><a href="statistics.html" title="Account Stats" data-toggle="tooltip" data-placement="right"><i class="ti-stats-up"></i></a></li>
				...
				<li><a href="setting.html" title="Setting" data-toggle="tooltip" data-placement="right"><i class="ti-panel"></i></a></li>
						...
						<div class="row merged20" id="page-contents">
							<div class="col-lg-12">
								<div class="search-meta">
									<span>Your search result for " <i>Php developer</i> " 12</span>
								</div>
							</div>
							<div class="col-lg-3">
										...
										<form class="c-form search" method="post">
											...
											<div>
												...
												<div class="form-radio">
												  <div class="radio">
													<label>
													  <input type="radio" checked="checked" name="radio"><i class="check-box"></i>Full Time
													</label>
												  </div>
												  <div class="radio">
													<label>
													  <input type="radio" name="radio"><i class="check-box"></i>Part Time
													</label>
												  </div>
													<div class="radio">
													<label>
													  <input type="radio" name="radio"><i class="check-box"></i>Temporary
													</label>
												  </div>
													<div class="radio">
													<label>
													  <input type="radio" name="radio"><i class="check-box"></i>Freelance
													</label>
												  </div>
												</div>
											</div>
											<div>
												...
												<div class="form-radio">
													<div class="radio">
														<label>
															<input type="radio" checked="checked" name="radio"><i class="check-box"></i>Less Than  1 year
														</label>
													</div>
													<div class="radio">
														<label>
															<input type="radio" name="radio"><i class="check-box"></i>2 Years
														</label>
													</div>
													<div class="radio">
														<label>
														  <input type="radio" name="radio"><i class="check-box"></i>3 Years
														</label>
													</div>
													<div class="radio">
														<label>
														  <input type="radio" name="radio"><i class="check-box"></i>4 Years
														</label>
													</div>
													<div class="radio">
														<label>
														  <input type="radio" name="radio"><i class="check-box"></i>5+ Years
														</label>
													</div>
												</div>
											</div>
											<div>
												...
												<div class="form-radio">
													<div class="radio">
														<label>
															<input type="radio" checked="checked" name="radio"><i class="check-box"></i>Last Hour
														</label>
													</div>
													<div class="radio">
														<label>
															<input type="radio" name="radio"><i class="check-box"></i>Today
														</label>
													</div>
													<div class="radio">
														<label>
															<input type="radio" name="radio"><i class="check-box"></i>Last Week
														</label>
													</div>
													<div class="radio">
														<label>
															<input type="radio" name="radio"><i class="check-box"></i>Last Month
														</label>
													</div>
												</div>
											</div>
							...
							<div class="col-lg-7">
								<div class="central-meta searched">
									<div class="user-post job">
										<div class="friend-info">
											...
											<div class="friend-name">
												<ins><em class="verify"><i class="fa fa-check-circle"></i></em> <a href="time-line.html" title="">Sophia</a></ins>
											...
											<div class="post-meta">
												<h6><a href="career-detail.html" title="">Senior Wordpress Developer Need</a></h6>
												<div class="description">
													<p>
														Need one WordPress developer with more than 5 years of experience and sound in kotlin to maintain our application.
													</p>
												</div>
												<div class="rate-n-apply">
													...
													<a href="career-detail.html" title="" class="main-btn" data-ripple="">Apply Now</a>
												</div>
								...
								<div class="central-meta searched">
									<div class="user-post job">
										<div class="friend-info">
											...
											<div class="friend-name">
												<ins><em class="verify"><i class="fa fa-check-circle"></i></em> <a href="time-line.html" title="">Andrew</a></ins>
												<span><i class="fa fa-clock-o"></i> Jan,1 2020</span>
											</div>
											<ol class="pit-rate">
												<li class="rated"><i class="fa fa-star"></i></li>
												<li class="rated"><i class="fa fa-star"></i></li>
											...
											<div class="post-meta">
												<h6><a href="career-detail.html" title=""> Php Developer Required</a></h6>
												<div class="description">
													<p>
														Need one WordPress developer with more than 5 years of experience and sound in kotlin to maintain our application.
													</p>
								...
								<div class="central-meta searched">
									<div class="user-post job">
										<div class="friend-info">
											...
											<div class="friend-name">
												<ins><em class="verify"><i class="fa fa-check-circle"></i></em> <a href="time-line.html" title="">George</a></ins>
												<span><i class="fa fa-clock-o"></i> Feb,12 2020</span>
											</div>
											<ol class="pit-rate">
												<li class="rated"><i class="fa fa-star"></i></li>
												<li class="rated"><i class="fa fa-star"></i></li>
											...
											<div class="post-meta">
												<h6><a href="career-detail.html" title="">Senior Android Developer</a></h6>
												<div class="description">
													<p>
														Need one WordPress developer with more than 5 years of experience and sound in kotlin to maintain our application.
													</p>
								...
								<div class="central-meta searched">
									<div class="user-post job">
										<div class="friend-info">
											...
											<div class="friend-name">
												<ins><em class="verify"><i class="fa fa-check-circle"></i></em> <a href="time-line.html" title="">Xing Xang</a></ins>
												<span><i class="fa fa-clock-o"></i> March,15 2020</span>
											</div>
											<ol class="pit-rate">
												<li class="rated"><i class="fa fa-star"></i></li>
												<li class="rated"><i class="fa fa-star"></i></li>
											...
											<div class="post-meta">
												<h6><a href="career-detail.html" title="">Graphic Designer Required</a></h6>
												<div class="description">
													<p>
														Need one WordPress developer with more than 5 years of experience and sound in kotlin to maintain our application.
													</p>
								...
								<div class="central-meta searched">
									<div class="user-post job">
										<div class="friend-info">
											...
											<div class="post-meta">
												<h6><a href="career-detail.html" title="">Senior Wordpress Developer Urgent Required</a></h6>
												<div class="description">
													<p>
														Need one WordPress developer with more than 5 years of experience and sound in kotlin to maintain our application.
													</p>
								...
								<div class="central-meta item">
									...
									<ul class="related-searches">
										<li><a title="" href="#">WordPress Developer</a></li>
										<li><a title="" href="#">Backend Developer</a></li>
										<li><a title="" href="#">Php developer</a></li>
										<li><a title="" href="#">Frontend and backend developer</a></li>
										<li><a title="" href="#">Web Developer</a></li>
									</ul>
								</div>
							</div>
							<div class="col-lg-2">
