...
<!-- Mirrored from wpkixx.com/html/pitnik/contribution.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Mar 2022 16:37:20 GMT -->
<head>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="pittop-banner">
							<figure><img src="images/resources/donation-bg.jpg" alt=""></figure>
							<div class="pittop-meta">
								<figure><img src="images/resources/donation-thumb.jpg" alt=""></figure>
								<div>
									<h6>Contribute Today!</h6>
									<span>230 joined us</span>
								</div>	
							</div>
						</div>
					</div>
						...
						<div class="row merged20" id="page-contents">
							<div class="col-lg-9">
								<div class="central-meta">
									<div class="don-left whitish high-opacity">
										<div class="bg-image" style="z-index: 0; background-image: url(images/resources/facebook-office.jpg)"></div>
										<div class="our-moto">
											<p><span>pitnik</span> we are proudly non-profit, non-corporate and non-compromised. Thousand of people like to help us stand up for an open web for all. We rely on donation to carry out our mission to keep the web open and free. Will you give today?</p>
										</div>
									 </div>
									<div class="don-right">
										<div class="don-form">
											...
											<form method="post" class="c-form">
												<div>
													<div class="form-radio">
													  <div class="radio">
														<label>
														  <input type="radio" name="radio" checked="checked"><i class="check-box"></i>One Time
														</label>
													  </div>
													  <div class="radio">
														<label>
														  <input type="radio" name="radio"><i class="check-box"></i>Monthly
														</label>
													  </div>
														<div class="radio">
														<label>
														  <input type="radio" name="radio"><i class="check-box"></i>Yearly
														</label>
													  </div>
													</div>
												</div>
											...
											<p>Your payment detail will be processed by stripe (for credit/debit cards) or paypal, and a record of your donation will be stored by Pitnik</p>
											<ul class="pay-methods">
												<li class="active"><i class="fa fa-cc-visa"></i> visa card / Master card</li>
												<li><i class="fa fa-paypal"></i> Paypal</li>
												<li><i class="fa fa-credit-card"></i> Payoneer</li>
												<li><i class="fa fa-money"></i> Direct Bank</li>
											</ul>
											
											<form method="post" class="c-form pay-card">
												<span>Payment Info</span>
												<div class="row merged10">
													<div class="col-lg-4 col-md-4">
														<input type="text" placeholder="Enter your 16 digit authorized number">
													</div>
													<div class="col-lg-4 col-md-4">
											...
											<form method="post" class="c-form personal">
												...
												<div class="row merged10">
													...
													<div class="col-lg-12">
														<button type="submit" class="main-btn">Proceed $550</button>
													</div>
												</div>
											</form>
										</div>
...
<!-- Mirrored from wpkixx.com/html/pitnik/contribution.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Mar 2022 16:37:22 GMT -->
</html>	