...
<!-- Mirrored from wpkixx.com/html/pitnik/soundnik-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Mar 2022 16:30:44 GMT -->
<head>
...
<div class="theme-layout">
	...
	<section>
		<div class="gap2 no-gap mate-black medium-opacity">
			<div class="parallax" style="background-image: url(images/resources/music-banner.jpg)"></div>
			<div class="container-fluid ext-50">
				<div class="row merged">
					<div class="col-lg-9 col-md-9">
						<div class="audio-single">
							<div class="about-user">
								<figure><img src="images/resources/audio-singe-avatar.jpg" alt=""></figure>
								<div class="singer-info">
									<h6>Street sings</h6>
									<span>3.2M followers</span>
									<em>Member since 2019</em>
								</div>
							</div>
							<h4 class="audio-heading">Hollywood Mashup songs 2020</h4>
							...
							<span class="uploadtime"><i class="fa fa-upload"></i>Feb 12, 2020</span>
							<ul class="follow">
								<li><a class="follow-me" href="#" title=""><i class="fa fa-star"></i> Follow Me</a></li>
								<li><a class="contribute" href="donation.html" title=""><i class="fa fa-heart-o"></i> Contribute</a></li>
					...
					<div class="col-lg-3 col-md-3">
						<div class="playlist-box">
							<h4><i class="fa fa-music"></i> Play List</h4>
							<ul class="music-list">
								<li>
									<figure><img src="images/resources/playlist1.jpg" alt=""></figure>
									<a href="#" title="">223's ft. 9lokknine</a>
								</li>
								<li>
									<figure><img src="images/resources/playlist2.jpg" alt=""></figure>
									<a href="#" title="">Bloody Shoes Official Songs</a>
								</li>
								<li>
									<figure><img src="images/resources/playlist3.jpg" alt=""></figure>
									<a href="#" title="">Black Balloons Reprise</a>
								</li>
								<li>
									<figure><img src="images/resources/playlist4.jpg" alt=""></figure>
									<a href="#" title="">uicideboy$ & ramirez but in another mood</a>
								</li>
								<li>
									<figure><img src="images/resources/playlist5.jpg" alt=""></figure>
									<a href="#" title="">When its all gone! (what you believe?)</a>
								</li>
								<li>
									<figure><img src="images/resources/playlist6.jpg" alt=""></figure>
									<a href="#" title="">Press start Feat. Oliver Tree</a>
								</li>
								<li>
									<figure><img src="images/resources/playlist2.jpg" alt=""></figure>
									<a href="#" title="">Fell In Love (feat. Fenix Flexin)</a>
								</li>
							</ul>
						</div>
					</div>
							...
							<div class="col-lg-9">
								<div class="central-meta">
									<div class="create-post">
										<div class="user-fig">
											<img src="images/resources/singer1.jpg" alt="">
											<a href="#" title="">Street Sings</a>
										</div>
									</div>
									<div class="about-video">
										...
										<div>
											...
											<p class="read-more-wrap">This is Street Sings channel, we are working for the dance and sing songs. this video is very awesome for the youngster. please vote this video and like our channel.dance is the great thing for the body and fitness, we aleady have dance team the name of channel is Alps channel..... <span class="read-more-target">Libero fuga facilis vel consectetur quos sapiente deleniti eveniet dolores tempore eos deserunt officia quis ab? Excepturi vero tempore minus beatae voluptatem!</span></p>
...
<!-- Mirrored from wpkixx.com/html/pitnik/soundnik-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Mar 2022 16:30:56 GMT -->
</html>	