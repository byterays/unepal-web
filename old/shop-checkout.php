...
<!-- Mirrored from wpkixx.com/html/pitnik/shop-checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Mar 2022 16:40:03 GMT -->
<head>
						...
						<div class="row merged20" id="page-contents">
									...
									<div class="row">
										...
										<div class="col-lg-10 col-md-9">
											<ul class="profile-menu">
												...
												<li>
													<a class="active" href="shop-checkout.html">Checkout</a>
												</li>
												<li>
							...
							<div class="col-lg-7">
								<div class="central-meta">
									<h4 class="create-post">Check Out</h4>
													...
													<div class="checkbox">
													  <label>
														<input type="checkbox" checked="checked"><i class="check-box"></i>
														  I Accept The <a title="" href="#"> Privacy Policy</a> and <a title="" href="#"> Terms of Service </a>
													  </label>
													</div>
												</div>
											</div>
							...
							<div class="col-lg-5">
								<div class="central-meta">
									<h4 class="create-post">Ordar Summary</h4>
									<div class="checkout-meta">
										<form method="post" class="c-form">
											<textarea rows="4" placeholder="Order Note"></textarea>
										</form>
										<ul class="cart-prod">
											<li>
												<span>Digital web Mockup</span>
										...
										<div class="total-line">
											<ul>
												<li><ins>cart total:</ins> <span><i>$</i>70.00</span></li>
												<li><ins>Discount:</ins> <span><i>$</i>10.00</span></li>
												<li><b>Total: </b><em>$60</em></li>
											</ul>
										</div>
											...
											<form class="c-form" method="post">
												<div>
													...
													<div class="form-radio">
													  <div class="radio">
														<label>
														  <input type="radio" name="radio" checked="checked"><i class="check-box"></i>Paypal
														</label>
													  </div>
													  <div class="radio">
														<label>
														  <input type="radio" name="radio"><i class="check-box"></i>Credit or Debit Card
														</label>
													  </div>
														<div class="radio">
														<label>
														  <input type="radio" name="radio"><i class="check-box"></i>Cash On Delivery
														</label>
													  </div>
													</div>
												</div>
