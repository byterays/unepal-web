...
<!-- Mirrored from wpkixx.com/html/pitnik/redpit-category.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Mar 2022 16:30:32 GMT -->
<head>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="central-meta no-margin">
						<ul class="pitred-trendings six">
							<li>
								<figure><img src="images/resources/trending1.jpg" alt=""></figure>
								<div class="pit-uzr">
									<a href="#" title="">A jocker can not spend his life luxury.</a>
									<div class="usr-fig">
							...
							<li>
								<figure><img src="images/resources/trending2.jpg" alt=""></figure>
								<div class="pit-uzr">
									<a href="#" title="">US Popular band working on new song.</a>
									<div class="usr-fig">
										<img src="images/resources/comet-2.jpg" alt="">
										<a href="#" title="">p/Alisa</a>
									</div>
								</div>
							</li>
							<li>
								<figure><img src="images/resources/trending3.jpg" alt=""></figure>
								<div class="pit-uzr">
									<a href="#" title="">American girls have issues after marriage.</a>
									<div class="usr-fig">
										<img src="images/resources/comet-3.jpg" alt="">
										<a href="#" title="">p/Xang Zong</a>
									</div>
								</div>
							</li>
							<li>
								<figure><img src="images/resources/trending4.jpg" alt=""></figure>
								<div class="pit-uzr">
									<a href="#" title="">Colorful God Creations in the universe.</a>
									<div class="usr-fig">
										<img src="images/resources/comet-4.jpg" alt="">
										<a href="#" title="">p/B.Frank</a>
									</div>
								</div>
							</li>
							<li>
								<figure><img src="images/resources/trending5.jpg" alt=""></figure>
								<div class="pit-uzr">
									<a href="#" title="">Boats always beautiful looking in the sea.</a>
									<div class="usr-fig">
										<img src="images/resources/comet-2.jpg" alt="">
										<a href="#" title="">p/Santa Banta</a>
									</div>
								</div>
							</li>
							<li>
								<figure><img src="images/resources/trending6.jpg" alt=""></figure>
								<div class="pit-uzr">
									<a href="#" title="">Volunteers working in africa from US.</a>
									<div class="usr-fig">
										<img src="images/resources/comet-1.jpg" alt="">
										<a href="#" title="">p/Andrew</a>
									</div>
								</div>
							</li>
						</ul>
					</div><!-- trending post carousel -->
				</div>
			</div>
		</div>
		</div>	
					...
					<div class="col-lg-9">
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-6">
								<div class="pst-change-style">
									<span>view</span>
									<ul class="view-pst-style">
										<li class="active"><a href="#" title=""><i class="fa fa-navicon"></i></a></li>
										<li><a href="#" title=""><i class="fa fa-th-list"></i></a></li>
									</ul>
									<select>
							...
							<div class="col-lg-6 col-md-6 col-sm-6">
								<div class="sub-cat">
									<select>
										...
										<option>Jokes</option>
										<option>Lifetip</option>
										<option>Listentothis</option>
										<option>Movies</option>
										<option>Music</option>
										<option>News</option>
										<option>NoSleeps</option>
										<option>Yoga</option>
										<option>z-axe</option>
									</select>
								</div>
						...
						<div class="load-more">
							...
							<div class="central-meta">
								<span class="create-post">Today's Tranding <a title="" href="#">View All</a></span>
								<ul class="pitred-trendings">
									<li>
										<figure><img src="images/resources/trending1.jpg" alt=""></figure>
										<div class="pit-uzr">
											<a href="#" title="">A jocker can not spend his life luxury.</a>
							...
							<div class="central-meta item">
								<div class="pit-post">
									...
									<div class="pit-post-deta">
										<h4><a href="social-post-detail.html" title="">Books are so beautiful for the study except the computer..</a></h4>
										<ul class="post-up-time">
											<li>
												<div class="usr-fig">
													<img src="images/resources/comet-1.jpg" alt="">
							...
							<div class="central-meta item">
								<div class="pit-post">
									<figure>
										<img src="images/resources/red-post3.jpg" alt="">
										<i class="fa fa-image"></i>
									</figure>
									<div class="pit-post-deta">
										<h4><a href="social-post-detail.html" title="">Girls feel happy to shopping is the moll..</a></h4>
										<ul class="post-up-time">
											<li>
												<div class="usr-fig">
													<img src="images/resources/comet-2.jpg" alt="">
													<a href="#" title="">p/Aima</a>
												</div>
											</li>
											<li><i class="fa fa-clock-o"></i> Feb 10, 2020</li>
											<li>link <a href="#" title="">https://www.abc.com</a></li>
										</ul>
										<ul class="pit-opt">
											<li class="comentz" title="Comments"><i class="fa fa-comment"></i><em>2.2k</em></li>
							...
							<div class="central-meta item">
								<div class="pit-post">
									<figure>
										<img src="images/resources/red-post4.jpg" alt="">
										<span><i class="fa fa-bolt"></i></span>
										<i class="fa fa-image"></i>
									</figure>
									<div class="pit-post-deta">
										<h4><a href="social-post-detail.html" title="">Plants are our life living style should be..</a></h4>
										<ul class="post-up-time">
											<li>
												<div class="usr-fig">
													<img src="images/resources/side-friend6.jpg" alt="">
													<a href="#" title="">p/Sophia</a>
												</div>
											</li>
											<li><i class="fa fa-clock-o"></i> March 22, 2020</li>
											<li>link <a href="#" title="">https://www.abc.com</a></li>
										</ul>
										<ul class="pit-opt">
											<li class="comentz" title="Comments"><i class="fa fa-comment"></i><em>2.2k</em></li>
							...
							<div class="central-meta item">
								<div class="pit-post">
									<figure>
										<img src="images/resources/red-post5.jpg" alt="">
										<i class="fa fa-link"></i>
									</figure>
									<div class="pit-post-deta">
										<h4><a href="social-post-detail.html" title="">My Personal life styles pictures ..</a></h4>
										<ul class="post-up-time">
											<li>
												<div class="usr-fig">
													<img src="images/resources/comet-3.jpg" alt="">
													<a href="#" title="">p/Xing Zang</a>
												</div>
											</li>
											<li><i class="fa fa-clock-o"></i> Dec 17, 2020</li>
											<li>link <a href="#" title="">https://www.abc.com</a></li>
										</ul>
										<ul class="pit-opt">
											<li class="comentz" title="Comments"><i class="fa fa-comment"></i><em>2.2k</em></li>
							...
							<div class="central-meta item">
								<div class="pit-post">
									<figure>
										<img src="images/resources/red-post6.jpg" alt="">
										<i class="fa fa-video"></i>
									</figure>
									<div class="pit-post-deta">
										<h4><a href="social-post-detail.html" title="">Baloons day in the united kingdom ..</a></h4>
										<ul class="post-up-time">
											<li>
												<div class="usr-fig">
													<img src="images/resources/comet-4.jpg" alt="">
													<a href="#" title="">p/Emily</a>
												</div>
											</li>
							...
							<div class="central-meta item">
								<div class="pit-post">
									<figure>
										<img src="images/resources/red-post7.jpg" alt="">
										<span><i class="fa fa-bolt"></i></span>
										<i class="fa fa-image"></i>
									</figure>
									<div class="pit-post-deta">
										<h4><a href="social-post-detail.html" title="">My College Teachers..</a></h4>
										<ul class="post-up-time">
											<li>
												<div class="usr-fig">
													<img src="images/resources/side-friend1.jpg" alt="">
											...
											<li><i class="fa fa-clock-o"></i> Apr 10, 2020</li>
											<li>link <a href="#" title="">https://www.abc.com</a></li>
										</ul>
										<ul class="pit-opt">
											<li class="comentz" title="Comments"><i class="fa fa-comment"></i><em>2.2k</em></li>
