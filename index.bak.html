			...
			<nav id="menu" class="res-menu">
				<ul>
					<li><span>Home Pages</span>
						<ul>
							<li><a href="index.html" title="">uNepal Default</a></li>
		...
		<div class="topbar stick">
			...
			<div class="top-area">
				...
				<ul class="setting-area">
					...
					<li><a href="newsfeed.html" title="Services" data-ripple="">Services</a></li>
					<li><a href="newsfeed.html" title="Jobs" data-ripple="">Jobs</a></li>
					<li><a href="newsfeed.html" title="Rental" data-ripple="">Rental</a></li>
					<li><a href="newsfeed.html" title="Events" data-ripple="">Events</a></li>
					<li><a href="newsfeed.html" title="News" data-ripple="">News</a></li>
					<li><a href="newsfeed.html" title="Blog" data-ripple="">Blog</a></li>
					<li>
						<a href="#" title="Friend Requests" data-ripple="">
							<img src="images/svg/user.png" alt=""><em class="bg-red">5</em>
						</a>
						<div class="dropdowns">
					...
					<li>
						<a href="#" title="Messages" data-ripple=""><img src="images/svg/chat.svg" alt=""><em
					...
					<li><a href="#" title="Languages" data-ripple=""><img src="images/svg/globe.svg" alt=""><em
								class="dark">ACT</em></a>
		...
		<section>
			<div class="gap2 gray-bg">
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="row merged20" id="page-contents">
								<div class="col-lg-3">
									<aside class="sidebar static left d-sm-none d-md-block">
										<div class="widget">
											<h4 class="widget-title">Profile</h4>
											<div class="your-page">
												<figure>
													<a href="#" title=""><img src="images/resources/friend-avatar8.jpg"
															alt=""></a>
													<span>@Monica12</span>
												</figure>
												<div class="page-meta">
												...
												<div class="page-likes">
													<ul class="nav nav-tabs likes-btn">
														<li class="nav-item"><a class="active" href="#folower"
																data-toggle="tab" data-ripple="">Followers</a></li>
														<li class="nav-item"><a class="" href="#folwing"
																data-toggle="tab" data-ripple="">Following</a></li>
													</ul>
													<!-- Tab panes -->
				...
				C97.3,23.7,75.7,2.3,49.9,2.5" />
												...
												<li>
													<a href="https://www.youtube.com/watch?v=PDluztBSaBc" title=""
														data-strip-group="mygroup" class="strip"
														data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img
															src="images/resources/last-vid2.jpg" alt="">
										...
										<div class="advertisment-box">
											...
											<figure>
												<a href="#" title="Advertisment"><img
														src="images/resources/ad-widget.gif" alt=""></a>
											</figure>
												...
												<div class="status-story">
													...
													<div class="row">
														...
														<div class="col-lg-8">
															...
															<div id="slideshow">
																<img class="slide"
																	src="../../../placehold.it/856x380/FF6347/FFFFFF%26text%3d1"
																	alt="11" />
																<img class="slide"
																	src="../../../placehold.it/856x380/6FC6F7/FFFFFF%26text%3d2"
																	alt="2" />
																<img class="slide"
																	src="../../../placehold.it/856x380/f3e686/FFFFFF%26text%3d3"
																	alt="3" />
																<img class="slide"
																	src="../../../placehold.it/856x380/71eea3/FFFFFF%26text%3d4"
																	alt="4" />
															</div>
														</div>
													</div>
									...
									<aside class="sidebar static right">
										...
										<div class="widget">
											...
											<ul class="nav nav-tabs trend">
												<li class="nav-item"><a class="active" href="#trend"
										...
										<div class="widget">
											<div class="banner high-opacity purple">
												<div class="bg-image"
													style="background-image: url(images/resources/baner-widgetbg2.jpg)">
												</div>
												<div class="post-job">
