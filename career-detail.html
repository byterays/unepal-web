...
<!-- Mirrored from wpkixx.com/html/pitnik/career-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Mar 2022 16:34:05 GMT -->
<head>
				...
				<div class="row">
					<div class="col-lg-6 col-md-8">
						<figure class="employer-thmb">
							<img src="images/resources/employer.jpg" alt="">
						</figure>
						<div class="employer-info">
							<i>Blue Tech Inc.</i>
							<h2>Senior Web Developer <span>Permanent</span></h2>
					...
					<div class="col-lg-6">
						...
						<div class="central-meta">
							...
							<ul class="related-links">
								<li><i class="fa fa-angle-right"></i><a href="#" title="">Full stack web developer</a></li>
								<li><i class="fa fa-angle-right"></i><a href="#" title="">Wordpress web developer</a></li>
								<li><i class="fa fa-angle-right"></i><a href="#" title="">Front-end developer</a></li>
								<li><i class="fa fa-angle-right"></i><a href="#" title="">Backend developer</a></li>
								<li><i class="fa fa-angle-right"></i><a href="#" title="">Designer for web</a></li>
								<li><i class="fa fa-angle-right"></i><a href="#" title="">Technicial Project Manager</a></li>
								<li><i class="fa fa-angle-right"></i><a href="#" title="">Technicial Project Manager</a></li>
								<li><i class="fa fa-angle-right"></i><a href="#" title="">Technicial Project Manager</a></li>
							</ul>
						</div>
...
<!-- Mirrored from wpkixx.com/html/pitnik/career-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Mar 2022 16:34:09 GMT -->
</html>