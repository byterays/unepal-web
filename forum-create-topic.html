...
<!-- Mirrored from wpkixx.com/html/pitnik/forum-create-topic.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Mar 2022 16:37:02 GMT -->
<head>
	...
	<section>
		<div class="page-header">
			<div class="header-inner">
				...
				<p>
					Welcome to Pitnik Social Network. This page is for the community where user can put some technicial questions about the pitnik policies.
				</p>
			</div>
							...
							<div class="central-meta">
								<form method="post" class="c-form">
									...
									<div>
										...
										<textarea rows="3" placeholder="write someting"></textarea>
									</div>
									<div>
										<label>Choose Optional Tags</label>
										<input type="text" placeholder="Jack Carter, william, ">
									</div>
									<div>
										<button class="main-btn" type="submit" data-ripple="">Post Topic</button>
