<div class="central-meta item">
    <div class="user-post">
        <div class="friend-info">
            <figure>
                <img src="<?= $config["theme"]["path"] ?>/assets/images/resources/nearly1.jpg" alt="">
            </figure>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <figure>
                                    <a href="#" title="" data-toggle="modal" data-target="#img-comt">
                                        <img src="<?= $config["theme"]["path"] ?>/assets/images/resources/album1.jpg" alt="">
                                    </a>
                                </figure>
                                <figure>
                                    <a href="#" title="" data-toggle="modal" data-target="#img-comt">
                                        <img src="<?= $config["theme"]["path"] ?>/assets/images/resources/album2.jpg" alt="">
                                    </a>
                                </figure>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <figure>
                                    <a href="#" title="" data-toggle="modal" data-target="#img-comt">
                                        <img src="<?= $config["theme"]["path"] ?>/assets/images/resources/album6.jpg" alt="">
                                    </a>
                                </figure>
                                <figure>
                                    <a href="#" title="" data-toggle="modal" data-target="#img-comt">
                                        <img src="<?= $config["theme"]["path"] ?>/assets/images/resources/album5.jpg" alt="">
                                    </a>
                                </figure>
                                <figure>
                                    <a href="#" title="" data-toggle="modal" data-target="#img-comt">
                                        <img src="<?= $config["theme"]["path"] ?>/assets/images/resources/album4.jpg" alt="">
                                    </a>
                ...
                <div class="we-video-info">
                    ...
                    <div class="users-thumb-list">
                        <a data-toggle="tooltip" title="Anderw" href="#">
                            <img alt="" src="<?= $config["theme"]["path"] ?>/assets/images/resources/userlist-1.jpg">
                        </a>
                        <a data-toggle="tooltip" title="frank" href="#">
                            <img alt="" src="<?= $config["theme"]["path"] ?>/assets/images/resources/userlist-2.jpg">
                        </a>
                        <a data-toggle="tooltip" title="Sara" href="#">
                            <img alt="" src="<?= $config["theme"]["path"] ?>/assets/images/resources/userlist-3.jpg">
                        </a>
                        <a data-toggle="tooltip" title="Amy" href="#">
                            <img alt="" src="<?= $config["theme"]["path"] ?>/assets/images/resources/userlist-4.jpg">
                        </a>
                        <a data-toggle="tooltip" title="Ema" href="#">
                            <img alt="" src="<?= $config["theme"]["path"] ?>/assets/images/resources/userlist-5.jpg">
                        </a>
                ...
                <ul class="we-comet">
                    <li>
                        <div class="comet-avatar">
                            <img src="<?= $config["theme"]["path"] ?>/assets/images/resources/nearly3.jpg" alt="">
                        </div>
                    ...
                    <li>
                        <div class="comet-avatar">
                            <img src="<?= $config["theme"]["path"] ?>/assets/images/resources/comet-4.jpg" alt="">
                        </div>
                        <div class="we-comment">
            ...
            <div class="post-meta">
                <figure>
                    <a href="https://www.youtube.com/watch?v=fF382gwEnG8" title="" data-strip-group="mygroup" class="strip vdeo-link" data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }">
                        <img src="<?= $config["theme"]["path"] ?>/assets/images/resources/user-post.jpg" alt="">
                        <i>
...
<div class="central-meta item">
    <div class="user-post">
        <div class="friend-info">
            ...
            <div class="post-meta">
                <figure>
                    <img src="<?= $config["theme"]["path"] ?>/assets/sponsors.gif" alt="">
                    <ul class="like-dislike">
                        <li><a class="bg-purple" href="#" title="Save to Pin Post"><i class="fa fa-thumb-tack"></i></a></li>
                        <li><a class="bg-blue" href="#" title="Like Post"><i class="ti-thumb-up"></i></a></li>
                        <li><a class="bg-red" href="#" title="dislike Post"><i class="ti-thumb-down"></i></a></li>
...
<div class="central-meta item">
    <div class="user-post">
        <div class="friend-info">
            <figure>
                <img alt="" src="<?= $config["theme"]["path"] ?>/assets/images/resources/friend-avatar10.jpg">
            </figure>
            <div class="friend-name">
                <div class="more">
                    <div class="more-post-optns"><i class="ti-more-alt"></i>
            ...
            <div class="post-meta">
                <div class="linked-image align-left">
                    <a title="" href="#"><img alt="" src="<?= $config["theme"]["path"] ?>/assets/images/resources/page1.jpg"></a>
                </div>
                <div class="detail">
...
<div class="central-meta item">
    <div class="user-post">
        <div class="friend-info">
            <figure>
                <img src="<?= $config["theme"]["path"] ?>/assets/images/resources/friend-avatar10.jpg" alt="">
            </figure>
            <div class="friend-name">
                <div class="more">
                    <div class="more-post-optns"><i class="ti-more-alt"></i>
...
<div class="central-meta item">
    <div class="user-post">
        <div class="friend-info">
            <figure>
                <img src="<?= $config["theme"]["path"] ?>/assets/images/resources/nearly6.jpg" alt="">
            </figure>
            <div class="friend-name">
                <div class="more">
                    <div class="more-post-optns"><i class="ti-more-alt"></i>
