...
<!-- Mirrored from wpkixx.com/html/pitnik/fav-page-create.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Mar 2022 16:36:57 GMT -->
<head>
						...
						<div class="row merged20" id="page-contents">
								...
								<aside class="sidebar static left">
									...
									<div class="widget">
										...
										<ul class="fav-community">
											...
											<li><i class="fa fa-map-marker"></i><a href="http://wpkixx.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="145b7771757a4b797b607178546d7b616679757d783a777b79">[email&#160;protected]</a></li>
										</ul>
									</div><!-- Page Community-->
							...
							<div class="col-lg-9">
								<div class="central-meta">
									<span class="create-post">Create New Page</span>
									<div class="page-createbox">
										<form method="post" class="c-form">
											<div class="row">
												...
												<div class="col-lg-12">
													<textarea placeholder="Additional info about page"></textarea>
												</div>
												
												<div class="col-lg-12">
													<div class="title1">Social Links</div>
													<div class="social-name">
														<label><i class="fa fa-facebook-square"></i> Facebook</label>
														<input type="text" placeholder="facebook.com/pitnik">
													</div>
													<div class="social-name">
													...
													<div class="social-name">
														<label><i class="fa fa-pinterest"></i> Pinterest</label>
														<input type="text" placeholder="facebook.com/pitnik">
													</div>
												</div>
												<div class="col-lg-12">
