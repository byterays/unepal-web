...
<!-- Mirrored from wpkixx.com/html/pitnik/ad-center.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Mar 2022 16:40:37 GMT -->
<head>
	...
	<div class="topbar stick">
		...
		<div class="top-area">
			...
			<ul class="setting-area">
				...
				<li class="ur-balance">
					<a href="newsfeed.html" title="Your Balance" data-ripple=""><i class="fa fa-database"></i></a>$2000
					<div class="dropdowns">
	...
	<section>
		<div class="page-header">
			<div class="header-inner">
				...
				<p>
					Welcome to Pitnik Social Network. This page is for the community where user boostup and promote app, post, page and connect more people. 
				</p>
			</div>
								...
								<div class="col-lg-4 col-md-6">
									<div class="boost-box">
										<a href="#" title="">
											...
											<span>Get More People to Contact</span>
											<p>Recommended</p>
										</a>
									</div>
								</div>
								<div class="col-lg-4 col-md-6">
									<div class="boost-box">
										<a href="#" title="">
											...
											<span>Get More Website visitors</span>
											<p>Recommended</p>
										</a>
									</div>
								</div>
								...
								<div class="col-lg-4 col-md-6">
									<div class="boost-box">
										<a href="#" title="">
											...
											<span>Get More Messages / Comments</span>
										</a>
									</div>
								</div>
								<div class="col-lg-4 col-md-6">
									<div class="boost-box">
										<a href="#" title="">
											...
											<span>Promote Your Content Page</span>
										</a>
									</div>
								</div>
								<div class="col-lg-4 col-md-6">
